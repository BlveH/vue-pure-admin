...
export const noticesData: TabItem[] = [
  {
    ...
    list: [
      ...
      },
      {
        ...
        title: "Chuyên gia front-end mà bạn giới thiệu đã vượt qua vòng phỏng vấn thứ ba",
        datetime: "a year ago",
        description: "",
        type: "1"
      },
    ...
    list: [
      {
        ...
        description: "Đôi khi sẽ có sóng gió và sóng gió, cánh buồm sẽ được treo thẳng ra biển",
        datetime: "a year ago",
        type: "2"
      },
      {
        ...
        description: "Đường khó đi, đường khó đi, muôn trùng khúc khuỷu, giờ tôi đã bình an vô sự.",
        datetime: "a year ago",
        type: "2"
      },
      {
  ...
  },
  {
    ...
    list: [
      ...
      },
      {
        ...
        description: "Chỉ định Xiaoxian hoàn thành bản cập nhật và phát hành trước 2022-12-12",
        datetime: "",

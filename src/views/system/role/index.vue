  ...
  <div class="main">
    ...
    >
      <el-form-item label="Role Name:" prop="name">
        <el-input v-model="form.name" placeholder="Please enter a role name" clearable />
      </el-form-item>
      <el-form-item label="Character ID:" prop="code">
        <el-input v-model="form.code" placeholder="Please enter a role ID" clearable />
      </el-form-item>
      <el-form-item label="State:" prop="status">
        <el-select v-model="form.status" placeholder="Please select a status" clearable>

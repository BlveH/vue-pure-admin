...
<template>
  <el-card>
    <template #header>
      <div>Sử dụng lại trang tab, tự động đóng khi vượt quá giới hạn (sử dụng kịch bản: định tuyến động)</div>
    </template>
    ...
    <p class="mt-4">
      ...
      hoặc
      <span class="text-red-500">giữ các thông số của url</span>, sau đó bạn cần kích hoạt tính năng ổn định của tab.
      <br />
      Cách mở: Có một biểu tượng nhỏ cho cài đặt ở góc trên bên phải của trang, nhấp vào nó, bạn sẽ thấy bảng cấu hình dự án, tìm sự kiên trì của trang tab và bật nó lên.
    </p>
  </el-card>
</template>

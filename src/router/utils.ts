...
// Filter the routes whose showLink is false in meta
        ...
        formatFlatteningRoutes(addAsyncRoutes(info)).map(
          (v: RouteRecordRaw) => {
            ...
            if (
              ...
              // Remember to use addRoute after pushing the route to routes, so that the route can jump normally
...
// Filter dynamic routes from the backend and regenerate canonical routes
